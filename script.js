...
document.addEventListener('DOMContentLoaded', () => {
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            // Filter gallery items with fade animation
    ...
    galleryItems.forEach(item => {
        item.addEventListener('click', () => {
            // Only open if item is visible (not filtered out)
    ...
    function updateLightboxContent() {
        // Find the item in currently visible items
        const item = visibleItems.find(el => parseInt(el.getAttribute('data-index')) === currentImageIndex);
        ...
        setTimeout(() => {
            ...
            lightboxCounter.textContent = `${visibleItems.indexOf(item) + 1} / ${visibleItems.length}`;
    ...
    function nextImage() {
        const currentVisibleIndex = visibleItems.findIndex(el => parseInt(el.getAttribute('data-index')) === currentImageIndex);
        const nextIndex = (currentVisibleIndex + 1) % visibleItems.length;
        currentImageIndex = parseInt(visibleItems[nextIndex].getAttribute('data-index'));
        updateLightboxContent();
    }
    
    function prevImage() {
        const currentVisibleIndex = visibleItems.findIndex(el => parseInt(el.getAttribute('data-index')) === currentImageIndex);
        const prevIndex = (currentVisibleIndex - 1 + visibleItems.length) % visibleItems.length;
        currentImageIndex = parseInt(visibleItems[prevIndex].getAttribute('data-index'));
        updateLightboxContent();
    }
    ...
    // ============================================
    // 6. ANIMATED COUNTER STATS (Intersection Observer)
    // ============================================
    ...
    // ============================================
    const revealElements = document.querySelectorAll('.section-header, .about-content, .about-image, .contact-form, .info-card');
